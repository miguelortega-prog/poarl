        ...
        <x-slot name="content">
            <form wire:submit.prevent="submit" id="create-run-form" class="space-y-8">
                <div class="grid grid-cols-3 gap-6">
                    ...
                    <div class="flex flex-col gap-3">
                        <x-label for="official_id" value="{{ __('Cédula funcionario') }}" />

                        <input
                            id="official_id"
                            name="official_id"
                            type="text"
                            wire:model.blur="officialId"
                            placeholder="{{ __('Ingrese la cédula del funcionario') }}"
                            class="block w-full rounded-3xl border border-gray-300 bg-white px-4 py-3 text-sm text-gray-700 shadow-sm transition focus:border-primary-500 focus:outline-none focus:ring-2 focus:ring-primary-500 dark:border-gray-600 dark:bg-gray-900 dark:text-gray-100"
                        />
                ...
                {{-- Alerta informativa --}}
                <div class="rounded-3xl border border-blue-200 bg-blue-50 px-4 py-3 dark:border-blue-800 dark:bg-blue-900/20">
                    <div class="flex items-start gap-3">
                        ...
                        <div class="flex-1">
                            <p class="text-sm text-blue-800 dark:text-blue-200">
                                <strong>{{ __('Importante:') }}</strong> {{ __('Los archivos de Excel con más de una hoja deben tener la misma estructura en cada hoja. Por favor, cargue los archivos uno por uno; no seleccione más de un archivo a la vez durante la carga.') }}
                            </p>
                        </div>
                    </div>
                </div>
                                        ...
                                        <div class="col-span-12 space-y-2 tablet:col-span-3 desktop:col-span-3">
                                            ...
                                            >
                                                ...
                                                <div x-show="isUploading" x-cloak class="space-y-1">
                                                    ...
                                                    <p class="text-xs text-gray-600 dark:text-gray-400 text-center" x-text="`${Math.round(progress)}%`"></p>
                                                </div>
        ...
        <x-slot name="footer">
            ...
            >
                ...
                <button
                    ...
                    :disabled="!canSubmit || @js($this->isSubmitting)"
                    :aria-disabled="(!canSubmit || @js($this->isSubmitting)).toString()"
                ...
                >
                    <span wire:loading.remove wire:target="submit">{{ __('Generar Trabajo') }}</span>
